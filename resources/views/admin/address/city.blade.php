            ...
            <div class="card-body">
                <div class="sbp-preview">
                    <div class="sbp-preview-content">
                        <form action="{{ route('admin.address.storeCity') }}" method="POST">
                            @csrf
                                ...
                                <select name="state_id" id="state_id" class="form-control">
                                   <option selected>Choose State..</option>
                                        @foreach ($states as $state)
                                            <option value="{{ $state->id }}" name = "state_id">{{ $state->name }}</option>
                                        @endforeach 
                                </select>
                            </div>
                            <div class="form-group">
                                <label for="city">City Name</label>
                                <input class="form-control" name="name" id="name" type="text" placeholder="Alor Gajah" />
                            </div>
                            <div class="form-group">
